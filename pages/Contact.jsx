                ...
                <div className="w-full max-w-3xl">
                    ...
                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <textarea rows="5" className="w-full bg-white border border-primary/20 rounded-2xl px-5 sm:px-6 py-3 sm:py-4 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all resize-none" placeholder="Waar ben je naar op zoek?"></textarea>
                        </div>

                        <button className="btn-magnetic w-full md:w-auto bg-accent text-background font-sans font-bold text-base sm:text-lg px-6 sm:px-10 py-3 sm:py-4 rounded-[2rem] hover:bg-accent/90 transition-colors mt-4">
                            Verstuur Aanvraag
                        </button>
                    </form>
                </div>
