...
export default function CTA() {
    return (
        <section className="relative w-full py-32 px-6 bg-background flex flex-col items-center justify-center">
            <div className="relative z-10 w-full max-w-4xl mx-auto bg-primary rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-12 md:p-20 text-center shadow-2xl overflow-hidden">
                {/* Background Accents */}
                ...
                <div className="relative z-20 flex flex-col items-center">
                    ...
                    <div className="flex justify-center w-full">
                        <Link to="/contact" className="btn-magnetic w-full sm:w-auto bg-accent text-background font-sans font-bold text-base sm:text-lg px-6 sm:px-10 py-3 sm:py-4 rounded-[2rem] hover:bg-accent/90 transition-colors flex items-center justify-center gap-3">
