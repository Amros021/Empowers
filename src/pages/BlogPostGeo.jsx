            ...
            <article className="w-full pt-40 pb-24 px-6 relative">
                <div className="max-w-4xl mx-auto">
                    ...
                    <figure className="w-full h-[400px] md:h-[500px] rounded-[3rem] overflow-hidden mb-16 relative bg-primary">
                        <div className="absolute inset-0 bg-[url('/images/blogs/wat-is-geo-generative-engine-optimization.jpg')] bg-cover bg-center opacity-40 mix-blend-overlay"></div>
                    ...
                    <div className="prose prose-lg prose-headings:font-sans prose-headings:font-bold prose-headings:text-primary prose-p:font-sans prose-p:text-primary/80 prose-p:leading-relaxed max-w-none">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Hoe verschilt GEO van SEO?</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <p className="text-primary/80 leading-relaxed mb-6">
                            Zoekmachines zoals Google draaien op keywords en backlinks. AI-modellen draaien op vertrouwen, autoriteit en context. Je moet dus anders denken over hoe je jezelf online presenteert. Een backlink van een grote nieuwssite helpt bij <Link to="/seo" className="text-accent hover:underline">SEO</Link>. Maar voor GEO is het net zo waardevol dat een branchedirectory jou vermeldt, of dat je FAQ-pagina direct antwoord geeft op veelgestelde vragen.
                        </p>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Hoe werkt GEO in de praktijk?</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Is GEO iets voor jouw bedrijf?</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Wat kun je morgen al doen?</h2>
