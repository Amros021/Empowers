...
export default function Nieuws() {
    useEffect(() => {
        // Using Helmet for SEO tags instead
    ...
    return (
        <main className="min-h-screen selection:bg-accent/30 selection:text-dark flex flex-col bg-background">
            <Helmet>
                ...
                <meta name="description" content="Blijf vooroplopen met de nieuwste inzichten over Meta Ads, TikTok Ads, GEO en conversietracking. Praktische tips van de marketeers van Empowers." />
                ...
                <meta property="og:description" content="Blijf vooroplopen met de nieuwste inzichten over Meta Ads, TikTok Ads, GEO en conversietracking. Praktische tips van de marketeers van Empowers." />
