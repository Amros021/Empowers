...
export default function BlogPostOnlineMarketingUitbestedenBureauResultaat() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <main className="min-h-screen selection:bg-accent/30 selection:text-dark flex flex-col bg-background">
            <Helmet>
                <title>Online marketing uitbesteden: hoe herken je een bureau dat resultaat levert? | Empowers</title>
                <meta name="description" content="Een marketingbureau kiezen dat écht resultaat oplevert? De vragen om vooraf te stellen, de rode vlaggen en de afspraken die je in elk contract moet hebben." />
                <link rel="canonical" href="https://www.empowers.nl/blogs/algemeen/online-marketing-uitbesteden-bureau-resultaat" />
                <meta property="og:title" content="Online marketing uitbesteden: hoe herken je een bureau dat resultaat levert?" />
                <meta property="og:description" content="Praktische gids om een marketingbureau te kiezen dat doet wat het belooft." />
            ...
            <article className="w-full pt-40 pb-24 px-6 relative">
                <div className="max-w-4xl mx-auto">
                    <nav className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-primary/50 mb-12">
                        ...
                        <ChevronRight className="w-3 h-3" />
                        <span className="text-primary truncate">Marketingbureau dat resultaat levert</span>
                    </nav>
                    ...
                    <figure className="w-full h-[400px] md:h-[500px] rounded-[3rem] overflow-hidden mb-16 relative bg-primary">
                        <div className="absolute inset-0 bg-[url('/images/blogs/online-marketing-uitbesteden-bureau-resultaat.jpg')] bg-cover bg-center opacity-40 mix-blend-overlay"></div>
                    ...
                    <div className="prose prose-lg max-w-none prose-headings:text-primary prose-headings:font-bold prose-a:text-accent prose-a:underline hover:prose-a:text-accent/80">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Het verschil tussen marketing maken en marketing performen</h2>
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Vraag 1: laat een account zien dat lijkt op het mijne</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Vraag 2: wie zit er dagelijks aan mijn account?</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Vraag 3: wat is de strategie als het tegenzit?</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Rode vlaggen die je nooit moet negeren</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Wat in elk contract hoort</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Hoeveel mag het kosten?</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <p className="text-primary/80 leading-relaxed mb-6">
                            Daarnaast komt natuurlijk je media-budget zelf. Voor een serieuze MKB-aanwezigheid op één performance-kanaal kom je vaak rond de 2.000 euro per maand uit als minimum om voldoende leerdata te genereren. Onder dat budget loopt vrijwel elke campagne onder de leerdrempel. Hoe je dat budget verdeelt over kanalen behandelen we in onze blog over <Link to="/blogs/strategie/online-marketing-strategie-mkb" className="text-accent hover:underline">online marketingstrategie voor MKB</Link>.
                        </p>

                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Hoe je een bureau test in de eerste 90 dagen</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                        ...
                        <h2 className="text-3xl font-bold text-primary mt-16 mb-6">Drie fouten die bedrijven maken bij de keuze</h2>
                        <p className="text-primary/80 leading-relaxed mb-6">
                    ...
                    <section className="mt-4">
                        <div className="space-y-6 not-prose">
                            <div className="border border-primary/10 rounded-xl p-6">
                                <h3 className="font-sans font-semibold text-primary text-lg mb-3">Hoe herken je een goed marketingbureau in een eerste gesprek?</h3>
                                <p className="font-sans text-primary/70 leading-relaxed">
                                    Een goed bureau stelt vooral vragen voordat het beloftes doet. Ze willen weten wat een lead voor jou waard is, wat je marge per klant is en welke conversiestappen je momenteel meet. Een bureau dat in het eerste gesprek al concrete groeicijfers belooft zonder die context te kennen, baseert zijn pitch op standaard verkooppraat, niet op jouw business.
                                </p>
                            </div>
                            <div className="border border-primary/10 rounded-xl p-6">
                                <h3 className="font-sans font-semibold text-primary text-lg mb-3">Welke KPI's spreek je af met een bureau?</h3>
                                <p className="font-sans text-primary/70 leading-relaxed">
                                    Stel altijd KPI's vast die zo dicht mogelijk bij omzet of marge zitten. CPL (kosten per lead) als je product een verkoopgesprek vereist, ROAS (return on ad spend) voor webshops, CAC (klantacquisitiekosten) als je SaaS draait. Vermijd KPI's als impressies, clicks of CTR als hoofddoel: die zeggen niets over wat je echt verdient.
                                </p>
                            </div>
                            <div className="border border-primary/10 rounded-xl p-6">
                                <h3 className="font-sans font-semibold text-primary text-lg mb-3">Wat zijn rode vlaggen bij een marketingbureau?</h3>
                                <p className="font-sans text-primary/70 leading-relaxed">
                                    Geen of weinig referenties uit jouw branche. Geen toegang willen geven tot je eigen accounts. Reporting waarin alleen positieve metrics worden uitgelicht. Een vast contract van meer dan zes maanden zonder evaluatiemoment. Het ontbreken van een duidelijke escalatieprocedure als het slechter loopt. Bij twee of meer van deze signalen: bedank ze.
                                </p>
                            </div>
                            <div className="border border-primary/10 rounded-xl p-6">
                                <h3 className="font-sans font-semibold text-primary text-lg mb-3">Wat moet er in een marketingcontract staan?</h3>
                                <p className="font-sans text-primary/70 leading-relaxed">
                            ...
                            <div className="border border-primary/10 rounded-xl p-6">
                                <h3 className="font-sans font-semibold text-primary text-lg mb-3">Hoeveel kost online marketing uitbesteden?</h3>
                                <p className="font-sans text-primary/70 leading-relaxed">
                                    Voor MKB-pakketten ligt de management fee meestal tussen 1.500 en 4.500 euro per maand, afhankelijk van het aantal kanalen en de complexiteit. Daar bovenop komt je advertentiebudget. Lage prijzen onder de 1.000 euro per maand betekenen vrijwel altijd dat je een junior of een sjabloon-aanpak krijgt zonder echte strategie.
                                </p>
                            </div>
                            <div className="border border-primary/10 rounded-xl p-6">
                                <h3 className="font-sans font-semibold text-primary text-lg mb-3">Hoe lang voordat je resultaten ziet?</h3>
                                <p className="font-sans text-primary/70 leading-relaxed">
                    ...
                    <section className="mt-16 pt-12 border-t border-primary/10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <Link to="/blogs/algemeen/zelf-adverteren-of-uitbesteden" className="group p-6 rounded-xl border border-primary/10 hover:border-accent/30 transition-all">
                                ...
                                <p className="text-primary/60 text-sm">Wanneer welke aanpak slimmer is voor jouw bedrijf.</p>
                            </Link>
            ...
            <section className="w-full pb-32 px-6">
                <div className="max-w-4xl mx-auto bg-primary rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
                    ...
                    <h2 className="relative z-10 font-drama italic text-background text-3xl sm:text-4xl md:text-5xl mb-6">Een partner zoeken die resultaat levert?</h2>
                    <p className="relative z-10 font-sans text-background/70 text-lg mb-10 max-w-xl mx-auto">We werken met heldere KPI's, transparante rapportage en eigenaarschap op jouw naam. Geen verborgen marges, wel meetbaar resultaat per maand.</p>
