    ...
    return (
        <main className="min-h-screen selection:bg-accent/30 selection:text-dark">
            <Helmet>
                ...
                <meta name="description" content="Empowers is een marketing bureau gespecialiseerd in Google Ads, Meta Ads, LinkedIn Ads, TikTok Ads, SEO en GEO. Wij versnellen jouw groei. Plan een gratis kennismaking." />
