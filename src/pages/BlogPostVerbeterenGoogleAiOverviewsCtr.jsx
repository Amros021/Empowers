                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-lg prose-headings:font-sans prose-headings:font-bold prose-headings:text-primary prose-p:font-sans prose-p:text-primary/80 prose-p:leading-relaxed max-w-none">
                        ...
                        <ul className="space-y-4 my-8 pl-6 list-disc marker:text-accent">
                            ...
                            <li><strong>Schrijf veel beter antwoord dan je concurrenten.</strong> AI-modellen zijn goed in beoordelen van kwaliteit. Als jouw tekst duidelijker, directer en meer compleet is, pikt de AI je op. Test dit: lees het antwoord van je concurrent op dezelfde vraag. Maak het jouwe nog twee keer zo goed.</li>
                        ...
                        <ul className="space-y-4 my-8 pl-6 list-disc marker:text-accent">
                            ...
                            <li><strong>Maak een duidelijke call-to-action.</strong> Als je bezoeker heeft gelezen wat hij wilde, wat moet hij dan doen? Bellen, mailen, kopenx? Zorg dat dit overduidelijk is. Een bezoeker van hoog-kwaliteit wil actie nemen, niet zoeken naar je contactformulier.</li>
                        ...
                        <ul className="space-y-4 my-8 pl-6 list-disc marker:text-accent">
                            <li><strong>Vraag gezaghebbende websites om je te noemen.</strong> Journalisten, bloggers, industrienummers. Zorg dat zij jouw expertise kennen. Een artikel dat je aanhaalt als expert heeft meer waarde dan 50 opmerkingen op Reddit.</li>
                        ...
                        <ul className="space-y-4 my-8 pl-6 list-disc marker:text-accent">
                            ...
                            <li><strong>Vergelijk je ROAS per kanaal.</strong> Zoetkverkeer kan minder zijn, maar beter betalen dan Social Media traffic. Welk kanaal geeft het meeste inkomsten per euro? Focus daar.</li>
            ...
            <section className="w-full pb-32 px-6">
                <div className="max-w-4xl mx-auto bg-primary rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
                    ...
                    <p className="relative z-10 font-sans text-background/70 text-lg mb-10 max-w-xl mx-auto">
                        Plan een gratis gesprek met onze SEO-experts. We checken waar je nu staat in AI Overviews en geven concrete stappen hoe je autoritatie en conversies opbouwt.
                    </p>
