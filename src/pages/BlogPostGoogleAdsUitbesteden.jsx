            ...
            <article className="w-full pt-40 pb-24 px-6 relative">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-12 rounded-2xl overflow-hidden bg-gradient-to-br from-accent/20 to-primary/10 h-96 flex items-center justify-center border border-primary/10">
                        <img
                            src="/images/blogs/google-ads-uitbesteden-wanneer-zelf.jpg"
                            alt="Google Ads uitbesteden"
                    ...
                    <div className="prose prose-lg max-w-none prose-headings:font-sans prose-headings:font-bold prose-headings:text-primary prose-a:text-accent prose-a:underline hover:prose-a:text-accent/80">
                        ...
                        <ul>
                            <li>Je budget kleiner dan 2.000 euro per maand is</li>
                            <li>Je minstens 12 uur per week beschikbaar hebt</li>
                            <li>Je Google Ads willen leren en begrijpen</li>
                            <li>Je kleine, simpele campagnes hebt</li>
                            <li>Je geen haast hebt met resultaten</li>
                        </ul>
                        ...
                        <ul>
                            <li>Je budget groter dan 3.000 euro per maand is</li>
                            <li>Je minder dan 5 uur per week beschikbaar hebt</li>
                            <li>Je snel resultaten en groei wilt</li>
                            <li>Je huidige ROAS onder 2:1 ligt</li>
                            <li>Je meerdere doelen hebt (leads, verkoop, awareness)</li>
                            <li>Je hudig beheer niet goed loopt</li>
                        </ul>
                        ...
                        <p>
                            Bij <a href="/diensten/google-ads" className="text-accent underline hover:text-accent/80">onze Google Ads-service</a> focussen we op jouw KPI's. We testen, optimaliseren en rapporteren wekelijks. We werken volledig transparant en je ziet precies wat je geld doet.
                        </p>
            ...
            <section className="py-24 px-6 bg-dark text-white text-center">
                <div className="max-w-2xl mx-auto">
                    <h2 className="font-sans font-bold text-2xl md:text-3xl mb-6">
                        Klaar om betere Google Ads resultaten te behalen?
                    </h2>
                    <p className="text-white/70 mb-10 text-lg leading-relaxed">
                        Of je nu zelf beheer of uitbesteding kiest, wij helpen je graag. Bel, mail of plan een gratis gesprek. We kijken naar jouw situatie en geven onafhankelijk advies over wat voor jouw bedrijf het beste werkt.
                    </p>
                    <Link
                        to="/contact"
